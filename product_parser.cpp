...
{
    Product* product = new Book(prodName_, price_, qty_, isbn_, author_);
    return product;
}
...
{
    Product* product = new Clothing(prodName_, price_, qty_, size_, brand_);
    return product;
}
...
{
    Product* product = new Movie(prodName_, price_, qty_, genre_, rating_);
    return product;
}
